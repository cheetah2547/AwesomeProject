    ...
    <View style={props.style}>
      ...
      <FlatList
        ...
        <View style={{marginRight: 10}}>
            ...
            <View style={{flexDirection :"row" , paddingHorizontal : 10, borderBottomLeftRadius : 10 , opacity : 0.5 , borderBottomRightRadius : 10 , borderWidth : 1}}>
                
            <View style={{padding : 10}}>
                <Text style ={{fontSize: 15, color: "red"}}>{item.month}</Text>
